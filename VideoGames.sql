...
CREATE TABLE Game (
	...
	--CONSTRAINT CK_Rating CHECK (Rating BETWEEN 0 AND 10)
);
...
('XDefiant' , 2024-5-21, 'Ubisoft' , 0.00, 'First Person Shooter', 8, 34.4),
...
('The Last of Us', 2013-6-14, 'Sony Interactive Entertainment', 10.99, 'Action-Adventure', 9, 20),
...
('Xbox One', 2013-11-2, 'Microsoft Corporation', 'Multimedia and entertainment', 499.00),
